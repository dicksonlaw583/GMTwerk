///@func tk_wave_sinusoid([wavelength, positiveOnly, <blend>, <blendArgs>], memory, mode, from, to, timeUnits)
...
switch (argument2) {
	...
	case 1:
		...
		argument1[@ 0] = t;
		// Wave
		var waveHeight = (argument0[1]) ? (0.5-0.5*cos(2*pi*phase)) : sin(2*pi*phase);
