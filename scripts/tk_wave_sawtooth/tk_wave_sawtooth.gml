///@func tk_wave_sawtooth([wavelength, positiveOnly, <blend>, <blendArgs>], memory, mode, from, to, timeUnits)
...
switch (argument2) {
	...
	case 1:
		...
		argument1[@ 0] = t;
		// Wave
		var waveHeight = (argument0[1]) ? phase : ((phase <= 0.5) ? (2*phase) : (2*phase-2));
